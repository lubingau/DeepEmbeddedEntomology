...
HD_PWD='/home/lubin/deep-embedded-entomology/boards/zyboz7_tcu/hardware/zyboz7_tcu/zyboz7_tcu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zyboz7_tcu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zyboz7_tcu_wrapper.tcl
